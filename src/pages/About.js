      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
            ...
            <p className="leading-relaxed lg:text-lg text-xs">
...
export function Statistic() {
  return (
    <div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-10 sm:py-24 mx-auto flex flex-wrap justify-center">
          <div className="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
            ...
            <div className="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
              ...
              <p className="leading-relaxed">Customer Ratings</p>
            </div>
            <div className="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
          ...
          <div className="lg:w-1/3 sm:w-1/3 w-full rounded-lg overflow-hidden mt-4 sm:mt-0">
            <img
