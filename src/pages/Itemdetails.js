...
function Itemdetails() {
 // Fetching id of individual item
  ...
  const products = items.products.find((item) => {return item.id === parseInt(id)});
...
export function Details({item}){
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={item.images}/>
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="flex">
          <span class="title-font font-medium text-2xl text-gray-900">₹{item.price*100}</span>
